...
/**
 * BEGIN LAYOUTLIB CHANGE This is a custom version that doesn't use the non
 * standard LinkedHashMap#eldest. END LAYOUTLIB CHANGE
 *
 ...
 * <a
 * href="http://developer.android.com/sdk/compatibility-library.html">Android's
...
public class LruCache<K, V>
{
        ...
        while (true)
        {
            ...
            synchronized (this)
            {
                ...
                for (Map.Entry<K, V> entry : map.entrySet())
                {
                    ...
                    if (entry != null && willEntryRemove(entry.getKey(), entry.getValue()))
                    {
                        break;
                    }
                }
    ...
    protected boolean willEntryRemove(K key, V value)
    {
        return true;
    }
